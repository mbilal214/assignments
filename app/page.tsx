  ...
  return (
    <div className=" bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-500 p-6 text-white">
      ...
      <div className="flex justify-center mb-8">
        <Image
          src="/PROFILE.jpeg"width={200} height={150} className="border-4 border-white "alt="Profile Picture"
        />
      </div>
      <div className="bg-white/10 p-6 rounded-lg mb-6 border border-white/30">
        <h2 className="text-3xl font-semibold">About Me</h2>
        <p className="mt-2 text-gray-200 ">
        I am currently pursuing a Bachelors in Information Technology (BSIT) at BBSUL University. Passionate about technology, UI/UX design, and software development, I am constantly exploring innovative solutions to enhance user experiences and create impactful digital products..
        </p>
      </div>
      ...
      <div className="bg-white/10 p-6 rounded-lg  mb-6  border-white/30">
        ...
        <p className="text-gray-200 mt-1">
          I gained hands-on experience in front-end web development through the Governor&rsquo;s Initiative in Artificial Intelligence, Web 3.0, and the Metaverse. This program enhanced my skills in modern web technologies, user-centric design, and emerging digital innovations.
        </p>
      </div>
